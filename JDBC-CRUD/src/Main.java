...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/javaworld", "javauser", "java1234")) {
            ...
            String query = "INSERT INTO city(Name, countryCode, District, Population) " + " VALUES('Chania','GRC', 'Crete', 100000)";
            ...
            String updQuery = "UPDATE city SET name = ? WHERE ID = ?";
            ...
            ResultSet resultUpd = stmtUpdate2.executeQuery("SELECT * FROM city "+"WHERE ID="+id2);
            ...
            Statement stmtDel2 = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);

            ResultSet resultDel = stmtDel2.executeQuery("SELECT * FROM city WHERE ID = "+id2);
